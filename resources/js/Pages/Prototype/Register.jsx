                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-200 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-3" action="#">
                                <div>
                                    <InputLabel forInpurt="nae" value="Name" />
                                    <TextInput
                                        type="text"
                                        name="name"
                                        id="name"
                            ...
                            /> */}
                                ...
                                <Link href={route("prototype.beer")}>
                                    <button
                                        type="submit"
                                        class="w-full text-black bg-white mt-2 hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                                    >
                                        Register
                                    </button>
                                </Link>
